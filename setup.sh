...
# ══════════════════════════════════════════════════════════════
# STEP 8: Generate .env with Secure Passwords
# ══════════════════════════════════════════════════════════════
...
# ══════════════════════════════════════════════════════════════
# STEP 10: Create GitHub Repository (optional)
# ══════════════════════════════════════════════════════════════
if [[ -n "$GITHUB_ORG" ]]; then
...
echo -e "  ${CYAN}2.${NC} Ensure Traefik is running with traefik-public network"
echo -e "  ${CYAN}3.${NC} make up          — Start the stack"
echo -e "  ${CYAN}4.${NC} make test        — Verify all connections"
echo -e "  ${CYAN}5.${NC} make status      — Check container health"
echo ""
